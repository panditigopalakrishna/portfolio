...
export default function EducationSection() {
  const education = [
    ...
    },
    {
      ...
      institution: "Computer Science - SASTRA University",
      year: "2022",
    ...
    },
    {
      ...
      institution: "Vignan Vihar E.M High School",
      year: "2016",
      icon: "fas fa-book",
          ...
          <div>
            ...
            <div className="space-y-6">
              {education.map((edu, index) => (
                <Card key={index} className={`${edu.bgColor} border border-primary/20 card-hover`}>
