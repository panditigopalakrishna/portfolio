...
import profilpic from "@/assets/profile-pic (2).png"
    ...
    <section id="home" className="min-h-screen flex items-center justify-center circuit-bg relative overflow-hidden pt-16">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="mb-8">
          ...
          <img 
            src={profilpic} 
            alt="Gopalakrishna Panditi - Professional Profile" 
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-foreground mb-6 animate-fade-in font-inter">
          <span className="text-primary">Gopalakrishna</span> Panditi
        </h1>
      ...
      <div className="absolute bottom-2 left-1/1.9 transform -translate-x-1/2 animate-bounce">
        <button 
